    ...
    <div className="container mx-auto space-y-6 p-4 pb-20 md:pb-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Create and manage your payment requests</p>
        </div>
        <Button onClick={() => router.push("/dashboard/request/create")} className="gap-2">
          ...
          {filteredRequests.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {filter === "all" ? "Create your first payment request" : `No ${filter} requests`}
              </p>
              <Button onClick={() => router.push("/dashboard/request/create")} className="mt-4 gap-2">
                <Plus className="h-4 w-4" />
                Create Request
              </Button>
            </div>
